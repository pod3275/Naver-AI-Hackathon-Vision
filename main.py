# -*- coding: utf-8 -*-
"""
Created on Tue Sep 17 21:31:29 2019
...
## for using re-ranking, import below
#from re-ranking import *
...
def bind_model(model):
    ...
    def infer(queries, db):
        ...
        # Query 개수: 18,027
        # Reference(DB) 개수: 36,748
        # Total (query + reference): 54,775
        ...
        db_output = ["./db_query_squared_7.pkl","./db_reference_squared_7.pkl"]

        # get representation vectors of query and reference images
        if os.path.exists(db_output[0]):
            ...
            # reference images vector calculate
...
def convnet_model_():
    ...
    '''
    x = Dense(512, name='pca',kernel_initializer='identity',
...
# randomly generate data consist of three same image
...
if __name__ == '__main__':
    ...
    if config.mode == 'train':
        ...
        # Saved model load
#        nsml.load(checkpoint='0', session='team_52/ir_ph2/428')
#        nsml.save('saved')
#        exit()

        # Initiate RMSprop optimizer
        deep_rank_model_.compile(loss=triplet_loss.batch_hard_triplet_loss, optimizer=Adam(lr=0.0001))
